            ...
            <ol className="frame-history">
              {leg.frames.map((f) => (
                <li key={f.frameNumber}>
                  Frame {f.frameNumber}: {f.winnerPlayerId === leg.homePlayerId ? leg.homePlayer.name : leg.awayPlayer.name}
                  {f.method === 'bnd' && <strong> (BND)</strong>}
                  {f.method === 'rnd' && <strong> (RND)</strong>}
                  {f.breakerPlayerId && (
                    <span className="muted">
                      {' '}- Break: {f.breakerPlayerId === leg.homePlayerId ? leg.homePlayer.name : leg.awayPlayer.name}
                    </span>
                  )}
                </li>
              ))}
        ...
        <ol className="frame-history">
          {fixture.frames.map((f) => (
            <li key={f.frameNumber}>
              ...
              {f.breakerPlayerId && (
                <span className="muted">
                  {' '}- Break: {f.breakerPlayerId === fixture.homePlayerId ? homeEntrant.name : awayEntrant.name}
                </span>
              )}
            </li>
          ))}
