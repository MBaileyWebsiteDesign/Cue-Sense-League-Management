        ...
        <table className="standings-table cs-standings-desktop">
          {isTeams ? (
            ...
            <>
              <thead>
                <tr>
                  <th title="Position">#</th><th>{isDoubles ? 'Pairing' : 'Player'}</th><th title="Played">P</th><th title="Won">W</th><th title="Lost">L</th><th title="Frames For">F</th><th title="Frames Against">A</th><th title="Frame Difference">+/-</th><th title="Break and Dish">BND</th><th title="Reverse Break and Dish">RND</th><th title="Authorised no-shows">NS</th><th title="Points">Pts</th>
                </tr>
              </thead>
              <tbody>
                {division.standings.map((row, i) => (
