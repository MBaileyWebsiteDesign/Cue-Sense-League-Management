        ...
        <table className="public-table">
          {isTeams ? (
            ...
            <>
              <thead>
                <tr>
                  <th title="Position">#</th><th>{data.entryType === 'doubles' ? 'Pairing' : 'Player'}</th><th title="Played">P</th><th title="Won">W</th><th title="Lost">L</th><th title="Frames For">F</th><th title="Frames Against">A</th><th title="Frame Difference">+/-</th><th title="Points">Pts</th>
                </tr>
              </thead>
              <tbody>
                {data.standings.map((row, i) => (
