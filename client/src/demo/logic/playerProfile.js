...
export function buildPlayerProfile(db, playerId) {
  ...
  // `outcome` is 'win', 'loss', or 'void' (force-completed 0-0 with no
  // winner by an admin closing the division/league early) - mirrors
  // server/src/services/playerProfile.js.
  ...
  // Trophy cabinet - mirrors server/src/services/playerProfile.js: every
  // Roll of Honour entry where this player was champion directly, or on the
  // roster of the winning team/pairing.
